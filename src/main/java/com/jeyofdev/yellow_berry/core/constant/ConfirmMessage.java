...
public class ConfirmMessage {
    public static final String REGISTER = "Your registration has been successfully recorded. A validation email has been sent to you. Please check your inbox and follow the instructions to complete your registration.";
    public static final String LOGIN = "Logged In";
    public static final String VALIDATE_ACCOUNT = "Your email is verified! You now have full access to your account.";
