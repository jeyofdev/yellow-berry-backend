...
public class ProductController {
    ...
    public ResponseEntity<DomainSuccessResponse<ProductDTO>> saveProduct(@RequestBody SaveProductDTO saveProductDTO) {
        Product product = productMapper.mapToEntity(saveProductDTO, tagService, categoryService, wishlistService);
    ...
    public ResponseEntity<DomainSuccessResponse<Object>> addProductToWishlist(
            @PathVariable("productId") UUID productId,
